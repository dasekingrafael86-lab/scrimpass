@echo off
rem Baut ScrimPassClient.exe (kein Konsolenfenster, laeuft als Tray-Symbol).
rem Auf einem Windows-PC mit installiertem Python ausfuehren: einfach doppelklicken.
cd /d "%~dp0"
