...
class MatchTracker:
    ...
    def __init__(self, on_result, clock=None):
...
class ApiClient:
    ...
    def _request(self, method, path, **kwargs):
        ...
        res = self.http.request(method, f"{self.api_base}{path}", headers=headers, timeout=15, **kwargs)
...
class Service:
    def __init__(self, api, stop_callback):
        ...
        self.tracker = MatchTracker(self._report_async)
